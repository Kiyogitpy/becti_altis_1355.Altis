//--- Custom loadout prefab for rhs_uh1h_hidf_unarmed
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhs_uh1h_hidf_unarmed_pending", true];
...
_vehicle setVariable ["loadout_type", "rhs_uh1h_hidf_unarmed_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
