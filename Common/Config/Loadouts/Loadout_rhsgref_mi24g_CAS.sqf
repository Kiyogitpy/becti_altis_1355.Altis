//--- Custom loadout prefab for rhsgref_mi24g_CAS
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhsgref_mi24g_cas_pending", true];
...
_vehicle setVariable ["loadout_type", "rhsgref_mi24g_cas_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
