//--- Custom loadout prefab for RHS_MELB_MH6M
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhs_melb_mh6m_pending", true];
...
_vehicle setVariable ["loadout_type", "rhs_melb_mh6m_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
