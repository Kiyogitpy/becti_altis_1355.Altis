//--- Custom loadout prefab for RHS_TU95MS_vvs_old
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhs_tu95ms_vvs_old_pending", true];
...
_vehicle setVariable ["loadout_type", "rhs_tu95ms_vvs_old_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
