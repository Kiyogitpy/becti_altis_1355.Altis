//--- Custom loadout prefab for RHS_Ka52_vvsc
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhs_ka52_vvsc_pending", true];
...
_vehicle setVariable ["loadout_type", "rhs_ka52_vvsc_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
