//--- Custom loadout prefab for rhsusf_CH53e_USMC_cargo
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhsusf_ch53e_usmc_cargo_pending", true];
...
_vehicle setVariable ["loadout_type", "rhsusf_ch53e_usmc_cargo_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
