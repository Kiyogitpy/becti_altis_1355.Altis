...
private _weapons   = parseSimpleArray "[""rhs_weap_fcs_ah64"",""rhs_weap_M197"",""rhs_weap_laserDesignator_AI"",""rhs_weap_DAGR_Launcher""]";
private _magazines = parseSimpleArray "[""rhs_mag_M197_750"",""rhs_LaserFCSMag"",""rhs_LaserMag_ai"",""rhs_mag_DAGR_8"",""rhs_mag_DAGR_8""]";
private _pylons    = parseSimpleArray "["""",""rhs_mag_DAGR_8"",""rhs_mag_M151_7_green"",""rhs_mag_M151_7_green"",""rhs_mag_DAGR_8"","""",""rhsusf_ANALE39_CMFlare_Chaff_Magazine_x4""]";
...
_vehicle setVariable ["loadout_type", "ah1z_gunship", true];
