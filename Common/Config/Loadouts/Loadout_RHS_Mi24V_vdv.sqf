//--- Custom loadout prefab for RHS_Mi24V_vdv
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhs_mi24v_vdv_pending", true];
...
_vehicle setVariable ["loadout_type", "rhs_mi24v_vdv_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
