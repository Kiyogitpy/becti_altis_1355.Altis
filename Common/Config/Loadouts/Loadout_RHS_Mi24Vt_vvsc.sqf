//--- Custom loadout prefab for RHS_Mi24Vt_vvsc
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhs_mi24vt_vvsc_pending", true];
...
_vehicle setVariable ["loadout_type", "rhs_mi24vt_vvsc_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
