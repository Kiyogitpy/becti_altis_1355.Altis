//--- Custom loadout prefab for rhs_mi28n_vvs
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhs_mi28n_vvs_pending", true];
...
_vehicle setVariable ["loadout_type", "rhs_mi28n_vvs_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
