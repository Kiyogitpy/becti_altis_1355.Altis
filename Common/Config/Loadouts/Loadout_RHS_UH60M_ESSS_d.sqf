//--- Custom loadout prefab for RHS_UH60M_ESSS_d
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhs_uh60m_esss_d_pending", true];
...
_vehicle setVariable ["loadout_type", "rhs_uh60m_esss_d_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
