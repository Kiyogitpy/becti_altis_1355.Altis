//--- Custom loadout prefab for rhs_ka60_grey
//
...
if ((count _weapons == 0) || {count _magazines == 0}) exitWith {
    _vehicle setVariable ["loadout_type", "rhs_ka60_grey_pending", true];
...
_vehicle setVariable ["loadout_type", "rhs_ka60_grey_custom", true];
_vehicle setVariable ["loadout_version", 1, true];
